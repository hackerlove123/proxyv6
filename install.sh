...
install_3proxy() {
    ...
    wget https://raw.githubusercontent.com/linucat/proxyv6/main/3proxy.service-Centos8 --output-document=/3proxy/3proxy-0.9.3/scripts/3proxy.service2
...
echo "Which port do you want to start from?: Example 20001"
read COUNT1
